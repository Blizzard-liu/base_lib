...
public class AnimDialogUtils {
    ...
    public AnimDialogUtils initView(ViewGroup contentView ,final View customView) {

        androidContentView = contentView;
    ...
    public void show() {
        ...
        AnimSpring.getInstance().startAnim( animContainer);
        isShowing = true;
    }
     ...
     */
    public void dismiss() {
        AnimSpring.getInstance().stopAnim( this);
    }
