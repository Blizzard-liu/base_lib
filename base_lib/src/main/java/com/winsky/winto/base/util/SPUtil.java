...
public class SPUtil {
     ...
     * 保存在手机里面的文件名
     */
    public static final String KEY_FILE_NAME = "sp_data";
    ...
    public static final String KEY_SP_AMP = "sp_amp";
    /**
    ...
    private SPUtil(final String spName) {
        sp = BaseApp.Companion.getInstance().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
